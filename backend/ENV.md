...
| `GEMINI_MODEL` | Optionnel — défaut `gemini-2.0-flash`. Si 404, essaie automatiquement `gemini-2.5-flash` puis `gemini-1.5-pro`. |
| `GEMINI_VISION_MODEL` | Alias legacy de `GEMINI_MODEL` (si `GEMINI_MODEL` absent). |
