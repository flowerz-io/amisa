...
export const MOCK_OPENAI_VISION: FashionVisionResult = {
  category: 'footwear',
...
export async function analyzeOpenAIFashionVision(
  imageBase64: string
  ...
  let parsed: FashionVisionResult = MOCK_OPENAI_VISION;
  try {
  ...
  console.log(`[PERF] openai_vision=${ms}ms`);
  return parsed;
}
